 ...
 * a Jump button that opens the HotJump code overlay, the current screen title,
 ...
 * reservation awaiting put), Back, Home, Jump, and Logout are all disabled so the
 * worker can't leave the screen until the transaction resolves.
 *
 ...
 * @param locked - When true, dims and disables Back, Home, Jump, and Logout
 */
export function Header({ title, onJump, disableNav = false, locked = false }: HeaderProps) {
