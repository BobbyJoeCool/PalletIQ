...
8. Confirming submits `PATCH /api/locations/range-hold` (Place) or `DELETE /api/locations/range-hold` (Release) with the same range/binSide/startLevel/endLevel plus `holdType` (both actions now, **v1.8.0**) and `reasonCode` (Place only).
